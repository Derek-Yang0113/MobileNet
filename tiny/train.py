...
# Save model
os.makedirs("checkpoints/tiny_v2", exist_ok=True)
torch.save(model.state_dict(), "checkpoints/tiny_v2/mobilenetv2_gtsrb.pth")
print("Model saved to checkpoints/tiny_v2/mobilenetv2_gtsrb.pth")
